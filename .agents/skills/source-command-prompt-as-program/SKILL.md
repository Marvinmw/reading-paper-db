---
name: "source-command-prompt-as-program"
description: "以 prompt 作为程序执行分析任务，不调用外部 LLM API"
---

# source-command-prompt-as-program

Use this skill when the user asks to run the migrated source command `prompt-as-program`.
